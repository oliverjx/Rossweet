        ...
        <div class="container text-light">
            <div class="w-100 d-flex justify-content-between">
                <div>
                    ...
                    <a class="navbar-sm-brand text-light text-decoration-none" href="tel:010-020-0340">809-00000000-0340</a>
                </div>
                <div>
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                <div class="flex-fill">
                    <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="shop.blade.php">Tienda</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="row">
                ...
                <div class="col-md-4 pt-5">
                    ...
                    <ul class="list-unstyled text-light footer-link-list">
                        ...
                        <li><a class="text-decoration-none" href="#">Ubicación tienda</a></li>
                ...
                <div class="row pt-2">
                    <div class="col-12">
                        <p class="text-left text-light">
                            ...
                            | Designed by <a rel="sponsored" href="https://templatemo.com" target="_blank">Keila</a>
                        </p>
                    </div>
                </div>
            </div>
