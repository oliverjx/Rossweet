        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 pb-5">
                <div class="h-100 py-5 services-icon-wap shadow">
                    ...
                    <p class="text-center"> Poder brindar postres de calidad y eficiencia, en donde podamos crear un sentido
                        de pertenencia con el cliente
                                                ...
                                                <div class="row">
                                                    <div class="col-3 p-md-5">
                                                        <a href="#"><img class="img-fluid brand-img"
                                                                src="{{ asset('storage/img/' . $brand->img) }}"
                                                                alt="{{ $brand->name }}"></a>
                                                    </div>
                                                </div>
                                            </div>
