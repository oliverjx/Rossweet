            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="phone_number" class="col-md-4 col-form-label text-md-end">{{ __('Número de teléfono') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="direction" class="col-md-4 col-form-label text-md-end">{{ __('Dirección') }}</label>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary" style="background-color: #e83e8c; color: white; border: none; padding: 10px 20px; border-radius: 5px;">
                                    {{ __('Registrarse') }}
                                </button>
                            </div>
                        </div>
